...
#rating_avg = list(AppInfo.objects.values('category').using('cluster0').annotate(average = Avg('rating')))
result = list(AppInfo_Mongo.objects.all().values().using('cluster0'))
print(result,"!!!!!")
