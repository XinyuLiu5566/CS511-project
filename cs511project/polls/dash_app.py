...
# category = ["App Name","App ID","Category","Rating","Rating Count","Install Number","Price","Size","System Required","Release Date", "Age Required", "Ad Support"]
...
dt = pd.DataFrame(list(AppInfo.objects.all().values()))
